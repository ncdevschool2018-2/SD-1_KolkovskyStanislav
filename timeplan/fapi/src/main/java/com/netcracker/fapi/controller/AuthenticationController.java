...
import com.netcracker.fapi.config.TokenProvider;
...
public class AuthenticationController {
    ...
    public ResponseEntity register(@RequestBody LoginUser loginUser){
        ...
        return ResponseEntity.ok(new AuthToken(token,userDetails.getUsername(),userDetails.getAuthorities().toString()));
    }
}
